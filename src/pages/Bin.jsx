    ...
    <>
        ...
        <div className="content_header d-flex justify-content-between align-items-center ">
            ...
            <div className="d-flex gap-2 align-items-center ">
                <button className="primary_outline_btn_sm empty_folder_btn " data-bs-toggle="tooltip" data-bs-placement="bottom" title="Empty folder"><i className="bx bx-trash-alt text-danger"></i> <span className="hide_mob">Empty folder</span></button>
